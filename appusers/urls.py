...
urlpatterns = [
    ...
    path('addclient/<str:name>/<str:defect>/<str:option>/<str:predicted_date>/<int:predicted_price>/<int:price>/<str:service>/<str:part>/<str:telephone>/<str:additional>/<str:payment>', ViewAddClient, name="addclient"),
